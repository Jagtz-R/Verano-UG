...
void commandParse(RobotContext& context, const String& topic, const String& payload) {
    ...
    if (command == "move") {
        ...
        context.currentCommand.joint1 = doc["joint1"] | 0;
        context.currentCommand.joint2 = doc["joint2"] | 0;
    }
...
void commandUpdate(RobotContext& context) {
    ...
    switch (context.currentCommand.type) {
        case CommandType::MOVE:
            ...
            Serial.print(context.currentCommand.joint1);
            Serial.print(", Joint2: ");
            Serial.println(context.currentCommand.joint2);
            break;
